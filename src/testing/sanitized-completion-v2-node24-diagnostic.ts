...
const script = path.join(process.cwd(), 'scripts', 'powershell-broker-completion-v2.ps1');
...
console.log('PASS full sanitized completion-v2 verification under Node 24.18.');
